            ...
            <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:18px;padding:32px;box-shadow:0 18px 35px rgba(15,43,26,0.08);">
                <tr>
                    <td>
                        ...
                        <p style="margin:0 0 16px 0;color:#5a5f5c;">Detectamos un nuevo inicio de sesión en la app de SportReserve.</p>
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                            <tr>
                                <td style="padding:12px 16px;border:1px solid #e3e7e4;border-radius:12px;">
                                    ...
                                    <span>{{ $ip ?? 'No disponible' }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding:12px 16px;border:1px solid #e3e7e4;border-radius:12px;margin-top:12px;">
                                    <strong style="color:#187c3b;display:block;">Ubicación</strong>
                                    <span>{{ $location ?? 'Sin datos' }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding:12px 16px;border:1px solid #e3e7e4;border-radius:12px;margin-top:12px;">
                                    <strong style="color:#187c3b;display:block;">Dispositivo</strong>
                                    <span>{{ $device ?? 'Desconocido' }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding:12px 16px;border:1px solid #e3e7e4;border-radius:12px;margin-top:12px;">
                                    <strong style="color:#187c3b;display:block;">Navegador</strong>
                            ...
                            <tr>
                                <td style="padding:12px 16px;border:1px solid #e3e7e4;border-radius:12px;margin-top:12px;">
                                    ...
                                    <span>{{ $loginTime->format('d/m/Y H:i:s') }}</span>
                                </td>
                            </tr>
                        </table>
                        <p style="margin:20px 0 0 0;color:#5a5f5c;">Si no reconoces este acceso te recomendamos cambiar la contraseña y cerrar las demás sesiones desde la app.</p>
